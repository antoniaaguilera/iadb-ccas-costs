global main "/Users/antoniaaguilera/ConsiliumBots Dropbox/antoniaaguilera@consiliumbots.com/BID/Cost_Estimation/"
global graphs "/Users/antoniaaguilera/ConsiliumBots Dropbox/antoniaaguilera@consiliumbots.com/BID/Cost_Estimation/graphs"

import excel "$main/input_data/parameters.xlsx", clear first
...
egen admin = rowtotal(implementation yearly_admin maintenance outreach monitoring teachers_eval_gob)
replace admin = monitoring+staff if cost_cat==2
egen schools = rowtotal(supplies staff)
egen teachers = rowtotal(application teachers_eval transport)
...
gen beneficios_mock = (year/10+0.9)^4+0.6 if cost_cat==3
...
* --------------------------------------------------------------------- *
import excel "$main/input_data/growthproj_ec.xlsx", clear firstrow
keep year population_teachers
gen applicants=0.14*population_teachers*0.02
gen country ="ECUADOR"
